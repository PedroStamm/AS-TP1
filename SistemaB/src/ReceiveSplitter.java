 ...
 */
public class ReceiveSplitter extends FilterFramework{
    ...
    public void run()
    {
        ...
        System.out.print( "\n" + this.getName() + "::ReceiveSplitter Reading...");
        ...
        while (true)
        {
            ...
            {
                ClosePorts();
                System.out.print( "\n" + this.getName() + "::ReceiveSplitter Exiting; bytes read: " + bytesread + " bytes written: " + byteswritten );
                break;
